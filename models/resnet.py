...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, label='ResNet'):
...
def resnet44(num_classes=10):
    return ResNet(BasicBlock, [7, 7, 7], num_classes=num_classes, label='ResNet-44')


def resnet56(num_classes=10):
    return ResNet(BasicBlock, [9, 9, 9], num_classes=num_classes, label='ResNet-56')


def resnet110(num_classes=10):
    return ResNet(BasicBlock, [18, 18, 18], num_classes=num_classes, label='ResNet-110')


def resnet1202(num_classes=10):
    return ResNet(BasicBlock, [200, 200, 200], num_classes=num_classes, label='ResNet-1202')
