...
if __name__ == '__main__':
    ...
    df = pd.DataFrame({'mem': mem_list, 'A-GEM': acc_aGEM, 'ER': acc_ER, 'OTR': acc_OTR, 'OTR+distill': acc_OTRDistill})
    ...
    plt.legend()
    plt.title('Split MNIST memory comparison ({}-IL)'.format(args.scenario))
